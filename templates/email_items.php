...
<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
		<tr>
			<th class="td" scope="col" style="text-align:left;"><?php _e( 'Product', 'ivole' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php _e( 'Quantity', 'ivole' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php _e( 'Price', 'ivole' ); ?></th>
			<th class="td" scope="col" style="text-align:left;"><?php _e( 'Review', 'ivole' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
